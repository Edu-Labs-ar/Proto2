// COPIED FROM https://github.com/StephenCleary/Deque/blob/master/src/Nito.Collections.Deque/Deque.cs
using System;
...
namespace Nito.Collections
{
  ...
  public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, System.Collections.IList
  {
    ...
    public T PeekFront() { return Count > 0 ? DoGetItem(0) : default(T); }

    public T PeekBack() { return Count > 0 ? DoGetItem(Count) : default(T); }
